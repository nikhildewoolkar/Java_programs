...
{
    JLabel l1, l2, l3, l4, l5, l6, l7, l8,l9,Login_Label;
    JTextField tf1, tf2, tf5, tf6, tf7,tf8;
    JButton btn1, btn2,Click_here;
   ...
   Registration()
    {
        ...
        Login_Label=new JLabel("Already User?");
       ...
       // tf8.setBounds(300, 350, 200, 30);
        ...
        Login_Label.setBounds(180, 400, 100, 30);
        Click_here.setBounds(270, 405, 100, 17);
      //  add(l9);
